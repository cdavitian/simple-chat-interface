...
/* Ensure ChatKit elements are not hidden by global styles */
openai-chatkit {
 ...
 */
function registerUploadedS3Object(_x) {
  return _registerUploadedS3Object.apply(this, arguments);
}
function _registerUploadedS3Object() {
  _registerUploadedS3Object = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(params) {
    var key, filename, bucket, r, errorText;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          key = params.key, filename = params.filename, bucket = params.bucket;
          _context.n = 1;
          return fetch('/api/files/ingest-s3', {
            method: 'POST',
            credentials: 'include',
            headers: {
        ...
        case 2:
          ...
          throw new Error("Failed to register S3 object: ".concat(r.status, " ").concat(errorText));
        case 3:
...
var fileStager = createFileStager();

/**
 * Call this from your custom tool AFTER its presigned PUT to S3 succeeds.
 */
function onCustomToolS3UploadSuccess(_x) {
...
function _fetchChatKitSession() {
  _fetchChatKitSession = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee10() {
    var response, errorText, sessionData;
    return App_regenerator().w(function (_context10) {
      while (1) switch (_context10.n) {
        ...
        case 4:
          sessionData = _context10.v;
          return _context10.a(2, sessionData);
      }
    }, _callee10);
  }));
  return _fetchChatKitSession.apply(this, arguments);
...
function getExpiryFromEk(token) {
  ...
  try {
    ...
    var b64 = parts[parts.length - 1].replace(/[^A-Za-z0-9+/=]/g, '');
...
function withTokenRefresh(_x2, _x3) {
  return _withTokenRefresh.apply(this, arguments);
}
function _withTokenRefresh() {
  _withTokenRefresh = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee11(getTokenFn, operationFn) {
    var retries,
      isUnauthorized,
      _args11 = arguments,
      _t6,
      _t7,
      _t8;
    return App_regenerator().w(function (_context11) {
      while (1) switch (_context11.p = _context11.n) {
        case 0:
          retries = _args11.length > 2 && _args11[2] !== undefined ? _args11[2] : 1;
          _context11.p = 1;
          _t6 = operationFn;
          _context11.n = 2;
          return getTokenFn();
...
function App_App() {
  ...
  (0,react.useEffect)(function () {
    ...
    var checkAuth = /*#__PURE__*/function () {
      var _ref2 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee() {
        var response, userData, _t;
  ...
  var initializeChatKit = /*#__PURE__*/function () {
    var _ref3 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee2() {
      var _sessionData$clientTo, _sessionData$publicKe, _sessionData, expiry, expiryDate, now, _t2;
      return App_regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 1:
            _sessionData = _context2.v;
            console.log('ChatKit session data received:', {
              hasClientToken: !!(_sessionData !== null && _sessionData !== void 0 && _sessionData.clientToken),
              clientTokenPrefix: (_sessionData === null || _sessionData === void 0 || (_sessionData$clientTo = _sessionData.clientToken) === null || _sessionData$clientTo === void 0 ? void 0 : _sessionData$clientTo.substring(0, 30)) || 'N/A',
              hasPublicKey: !!(_sessionData !== null && _sessionData !== void 0 && _sessionData.publicKey),
              publicKeyPrefix: (_sessionData === null || _sessionData === void 0 || (_sessionData$publicKe = _sessionData.publicKey) === null || _sessionData$publicKe === void 0 ? void 0 : _sessionData$publicKe.substring(0, 30)) || 'N/A'
            });

            // Optional: Check token expiry
            if (_sessionData !== null && _sessionData !== void 0 && _sessionData.clientToken) {
              expiry = getExpiryFromEk(_sessionData.clientToken);
              if (expiry) {
                ...
                console.log('[ChatKit] Token expiry:', {
                  ...
                  timeUntilExpiry: expiryDate > now ? "".concat(Math.round((expiryDate - now) / 1000), "s") : 'EXPIRED'
                });
              }
            }
          ...
          case 2:
            _context2.p = 2;
            _t2 = _context2.v;
            console.error('ChatKit session initialization failed:', _t2);
    ...
    return function initializeChatKit() {
  ...
  if (loading) {
    ...
    }), /*#__PURE__*/react.createElement("p", null, "Loading ChatKit...")));
  }
  if (error) {
    return /*#__PURE__*/react.createElement("div", {
      className: "app-container"
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "loading-spinner"
  }), /*#__PURE__*/react.createElement("p", null, "Initializing chat interface...")) : /*#__PURE__*/react.createElement(ChatKitComponent, {
    sessionData: sessionData,
    onSessionUpdate: function onSessionUpdate(freshSession) {
      return setSessionData(freshSession);
    },
    user: user
  })));
}
function ChatKitComponent(_ref4) {
  var _sessionData$clientTo2, _sessionData$clientTo3, _sessionData$publicKe2;
  var sessionData = _ref4.sessionData,
    onSessionUpdate = _ref4.onSessionUpdate,
    user = _ref4.user;
  console.log('[ChatKit] ========================================');
  ...
  console.log('[ChatKit] SessionData details:', {
    ...
    clientTokenLength: (sessionData === null || sessionData === void 0 || (_sessionData$clientTo2 = sessionData.clientToken) === null || _sessionData$clientTo2 === void 0 ? void 0 : _sessionData$clientTo2.length) || 0,
    clientTokenPrefix: (sessionData === null || sessionData === void 0 || (_sessionData$clientTo3 = sessionData.clientToken) === null || _sessionData$clientTo3 === void 0 ? void 0 : _sessionData$clientTo3.substring(0, 30)) || 'N/A',
    hasPublicKey: !!(sessionData !== null && sessionData !== void 0 && sessionData.publicKey),
    publicKeyPrefix: (sessionData === null || sessionData === void 0 || (_sessionData$publicKe2 = sessionData.publicKey) === null || _sessionData$publicKe2 === void 0 ? void 0 : _sessionData$publicKe2.substring(0, 30)) || 'N/A',
    ...
    var _ref5 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee3(file) {
      ...
      return App_regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 1:
            presignResp = _context3.v;
            if (presignResp.ok) {
              _context3.n = 3;
              break;
            }
            _context3.n = 2;
            return presignResp.text();
          case 2:
            errorText = _context3.v;
            throw new Error("Failed to presign upload: ".concat(presignResp.status, " ").concat(errorText));
          case 3:
            _context3.n = 4;
            return presignResp.json();
          case 4:
  ...
  var onFileSelect = (0,react.useCallback)(function (e) {
    var _e$target$files;
  ...
  var composerConfig = (0,react.useMemo)(function () {
    return {
      attachments: {
        enabled: false,
        // Disable to prevent built-in upload mechanism
        ...
        return App_regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              ...
              console.log('[ChatKit] 🔐 Called with currentClientSecret:', (currentClientSecret === null || currentClientSecret === void 0 ? void 0 : currentClientSecret.substring(0, 30)) + '...');
            ...
            case 3:
              ...
              expiry = getExpiryFromEk(freshSession.clientToken);
              if (expiry) {
                expiryDate = new Date(expiry * 1000);
                now = new Date();
                if (expiryDate < now) {
  ...
  (0,react.useEffect)(function () {
    var hideComposer = function hideComposer() {
      var el = document.querySelector('openai-chatkit');
      if (!(el !== null && el !== void 0 && el.shadowRoot)) {
        return false;
      }

      // Find and hide the composer container/elements
      // Try multiple selectors to find the composer
      var composerSelectors = ['[class*="composer"]', '[class*="Composer"]', '[class*="input-container"]', '[class*="InputContainer"]', 'form', 'textarea', 'input[type="text"]', '[contenteditable="true"]', 'button[type="submit"]', 'button[aria-label*="send" i]', 'button[aria-label*="Send" i]'];
      var hidden = false;
      composerSelectors.forEach(function (selector) {
        var elements = el.shadowRoot.querySelectorAll(selector);
        elements.forEach(function (elem) {
          var _elem$getAttribute;
          // Check if element is likely part of the composer
          var isComposer = elem.closest('[class*="composer"]') || elem.closest('form') || elem.tagName === 'TEXTAREA' || elem.tagName === 'INPUT' || elem.tagName === 'BUTTON' && (elem.getAttribute('type') === 'submit' || ((_elem$getAttribute = elem.getAttribute('aria-label')) === null || _elem$getAttribute === void 0 ? void 0 : _elem$getAttribute.toLowerCase().includes('send')));
          if (isComposer) {
      ...
      var allElements = el.shadowRoot.querySelectorAll('*');
      allElements.forEach(function (elem) {
        var _elem$className, _elem$id;
        var className = ((_elem$className = elem.className) === null || _elem$className === void 0 ? void 0 : _elem$className.toLowerCase()) || '';
        var id = ((_elem$id = elem.id) === null || _elem$id === void 0 ? void 0 : _elem$id.toLowerCase()) || '';
        if ((className.includes('composer') || className.includes('input') || id.includes('composer') || id.includes('input')) && !className.includes('message') && !id.includes('message')) {
          elem.style.display = 'none';
          elem.style.visibility = 'hidden';
          elem.style.opacity = '0';
          elem.style.height = '0';
    ...
    var timeouts = [100, 300, 500, 1000, 2000, 3000];
    timeouts.forEach(function (delay) {
      setTimeout(function () {
        var hidden = hideComposer();
        if (hidden) {
          console.log("[ChatKit] \u2705 Composer hidden successfully (delay: ".concat(delay, "ms)"));
        }
      }, delay);
    });
  ...
  }, [sessionData === null || sessionData === void 0 ? void 0 : sessionData.sessionId]);

  // CENTRALIZED MESSAGE SEND FUNCTION
  // All messages must go through this function - no direct ChatKit API calls allowed
  var sendUserPrompt = (0,react.useCallback)(/*#__PURE__*/function () {
    var _ref7 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee5(event) {
      var _event$preventDefault, _event$stopPropagatio, _composerInput$value, _composerInput$textCo, el, composerInput, userPrompt, content, resp, errorText, result, _t5;
      return App_regenerator().w(function (_context5) {
        while (1) switch (_context5.p = _context5.n) {
          ...
          case 1:
            ...
            el = document.querySelector('openai-chatkit');
            if (el !== null && el !== void 0 && el.shadowRoot) {
              _context5.n = 2;
              break;
            }
            ...
            return _context5.a(2);
          case 2:
            composerInput = el.shadowRoot.querySelector('textarea, input[type="text"], [contenteditable="true"]');
            if (composerInput) {
              _context5.n = 3;
              break;
            }
          ...
          case 3:
            ...
            userPrompt = ((_composerInput$value = composerInput.value) === null || _composerInput$value === void 0 ? void 0 : _composerInput$value.trim()) || ((_composerInput$textCo = composerInput.textContent) === null || _composerInput$textCo === void 0 ? void 0 : _composerInput$textCo.trim()) || ''; // Build content array: text + any staged files
            content = fileStager.toMessageContent(userPrompt);
            if (!(content.length === 0)) {
              _context5.n = 4;
              break;
            }
          ...
          case 6:
            ...
            throw new Error("Failed to send message: ".concat(resp.status, " ").concat(errorText));
          case 7:
            _context5.n = 8;
            return resp.json();
          case 8:
          ...
          case 9:
            _context5.p = 9;
            _t5 = _context5.v;
            console.error('[ChatKit] ❌ sendUserPrompt failed:', _t5);
          case 10:
            return _context5.a(2);
        }
      }, _callee5, null, [[0, 9]]);
  ...
  (0,react.useEffect)(function () {
    ...
    var blockingFetch = /*#__PURE__*/function () {
      var _ref8 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee6() {
        var _len,
          args,
          _key,
          url,
        ...
        return App_regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            case 0:
              ...
              url = args[0], _args$ = args[1], options = _args$ === void 0 ? {} : _args$; // Check if this is a ChatKit message creation request
              urlString = typeof url === 'string' ? url : (url === null || url === void 0 ? void 0 : url.toString()) || '';
              isChatKitMessageCreate = urlString.includes('/chatkit') && urlString.includes('/messages') && (options.method === 'POST' || options.method === 'PUT');
              ...
              return _context6.a(2, Promise.reject(new Error('Direct ChatKit message API calls are disabled. Use sendUserPrompt() instead.')));
            case 1:
              return _context6.a(2, originalFetch.apply(window, args));
          }
        }, _callee6);
      }));
      return function blockingFetch() {
  ...
  (0,react.useEffect)(function () {
    ...
    var attachInterceptIfPossible = function attachInterceptIfPossible() {
      var el = document.querySelector('openai-chatkit');
      if (!el) {
      ...
      var composerInput = el.shadowRoot.querySelector('textarea, input[type="text"], [contenteditable="true"]');
      if (!composerInput) {
      ...
      var keydownHandler = /*#__PURE__*/function () {
        var _ref9 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee7(evt) {
          return App_regenerator().w(function (_context7) {
            while (1) switch (_context7.n) {
              case 0:
                ...
                _context7.n = 1;
                return sendUserPrompt(evt);
              case 1:
                return _context7.a(2);
            }
          }, _callee7);
        }));
        return function keydownHandler(_x7) {
      ...
      var clickHandler = /*#__PURE__*/function () {
        var _ref0 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee8(evt) {
          var _target$closest, _target$closest2;
          var target;
          return App_regenerator().w(function (_context8) {
            while (1) switch (_context8.n) {
              case 0:
                target = evt.target; // Look for send button (common patterns)
                if (!(target.closest('button[type="submit"]') || (_target$closest = target.closest('button')) !== null && _target$closest !== void 0 && (_target$closest = _target$closest.ariaLabel) !== null && _target$closest !== void 0 && _target$closest.toLowerCase().includes('send') || (_target$closest2 = target.closest('[role="button"]')) !== null && _target$closest2 !== void 0 && (_target$closest2 = _target$closest2.getAttribute('aria-label')) !== null && _target$closest2 !== void 0 && _target$closest2.toLowerCase().includes('send'))) {
                  _context8.n = 1;
                  break;
                }
        ...
        return function clickHandler(_x8) {
      ...
      var formSubmitHandler = /*#__PURE__*/function () {
        var _ref1 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee9(evt) {
          return App_regenerator().w(function (_context9) {
        ...
        return function formSubmitHandler(_x9) {
          return _ref1.apply(this, arguments);
        };
      }();

      // Attach all handlers
      composerInput.addEventListener('keydown', keydownHandler, {
        capture: true,
        passive: false
      });
      el.shadowRoot.addEventListener('click', clickHandler, {
        capture: true,
        passive: false
      });
      el.shadowRoot.addEventListener('submit', formSubmitHandler, {
        capture: true,
        passive: false
      });
    ...
    var timeouts = [0, 300, 1000, 2000, 3000];
    var attached = false;
    var attempts = [];
    timeouts.forEach(function (t) {
      var timeoutId = setTimeout(function () {
        if (!attached) {
          console.log("[ChatKit] \uD83D\uDD04 Attempting to attach intercept (delay: ".concat(t, "ms)..."));
    ...
    var globalKeydownHandler = /*#__PURE__*/function () {
      var _ref10 = App_asyncToGenerator(/*#__PURE__*/App_regenerator().m(function _callee0(evt) {
        var el, activeEl, _evt$composedPath, path, isFromChatKit, shadowRoot, composerInput, _composerInput$value2, _composerInput$textCo2, text;
        return App_regenerator().w(function (_context0) {
          while (1) switch (_context0.n) {
            ...
            case 1:
              ...
              path = ((_evt$composedPath = evt.composedPath) === null || _evt$composedPath === void 0 ? void 0 : _evt$composedPath.call(evt)) || [];
              isFromChatKit = path.some(function (node) {
                return node === el || (node === null || node === void 0 ? void 0 : node.host) === el;
              });
              if (isFromChatKit) {
                _context0.n = 2;
                break;
            ...
            case 2:
              ...
              return _context0.a(2);
            case 3:
              composerInput = shadowRoot.querySelector('textarea, input[type="text"], [contenteditable="true"]');
              if (composerInput) {
                _context0.n = 4;
                break;
              }
            ...
            case 4:
              ...
              text = (composerInput === null || composerInput === void 0 || (_composerInput$value2 = composerInput.value) === null || _composerInput$value2 === void 0 ? void 0 : _composerInput$value2.trim()) || (composerInput === null || composerInput === void 0 || (_composerInput$textCo2 = composerInput.textContent) === null || _composerInput$textCo2 === void 0 ? void 0 : _composerInput$textCo2.trim()) || '';
      ...
      return function globalKeydownHandler(_x0) {
  ...
  }, [sessionData === null || sessionData === void 0 ? void 0 : sessionData.sessionId, sendUserPrompt]);
  ...
  (0,react.useEffect)(function () {
    if (!(sessionData !== null && sessionData !== void 0 && sessionData.clientToken) && getClientSecret) {
      console.log('[ChatKit] 🔄 No initial token, calling getClientSecret proactively...');
      getClientSecret(null).then(function (token) {
        console.log('[ChatKit] ✅ Proactive getClientSecret returned token:', (token === null || token === void 0 ? void 0 : token.substring(0, 30)) + '...');
        if (onSessionUpdate) {
          onSessionUpdate({
            clientToken: token,
            publicKey: sessionData === null || sessionData === void 0 ? void 0 : sessionData.publicKey
          });
        }
      })["catch"](function (err) {
  ...
  if (!(sessionData !== null && sessionData !== void 0 && sessionData.publicKey)) {
    return /*#__PURE__*/react.createElement("div", {
      style: {
        width: '100%',
        height: '600px',
  ...
  }, uploadingFile ? '📤 Uploading...' : '📎 Upload File'), uploadStatus && /*#__PURE__*/react.createElement("div", {
    style: {
      padding: '10px 15px',
...
root.render(/*#__PURE__*/react.createElement(src_App_0, null));
/******/ })()
;