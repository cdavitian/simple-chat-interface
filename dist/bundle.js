...
function App_App() {
  ...
  var initializeChatKit = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var response, errorText, _sessionData, _t2;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 4:
            ...
            console.log('ChatKit session data received:', _sessionData);
  ...
  var _useChatKit = useChatKit({
      api: {
        getClientSecret: function () {
          var _getClientSecret = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(currentClientSecret) {
            return _regenerator().w(function (_context3) {
              while (1) switch (_context3.n) {
                case 0:
                  console.log('getClientSecret called with:', currentClientSecret);
                  console.log('Returning clientToken:', sessionData === null || sessionData === void 0 ? void 0 : sessionData.clientToken);
                  return _context3.a(2, sessionData === null || sessionData === void 0 ? void 0 : sessionData.clientToken);
              }
            }, _callee3);
          }));
          function getClientSecret(_x) {
  ...
  (0,react.useEffect)(function () {
    var checkElement = function checkElement() {
      ...
      if (el) {
        ...
        console.log('Shadow DOM:', (_el$shadowRoot = el.shadowRoot) === null || _el$shadowRoot === void 0 ? void 0 : _el$shadowRoot.querySelector('*'));
        console.log('Element styles:', getComputedStyle(el).cssText);

        // Try to manually set options if shadow DOM is missing
        if (!el.shadowRoot && sessionData !== null && sessionData !== void 0 && sessionData.clientToken) {
