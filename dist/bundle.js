...
function _fetchChatKitSession() {
  _fetchChatKitSession = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.n) {
        ...
        case 4:
          sessionData = _context5.v;
          return _context5.a(2, sessionData);
      }
    }, _callee5);
  }));
  return _fetchChatKitSession.apply(this, arguments);
...
function withTokenRefresh(_x, _x2) {
  return _withTokenRefresh.apply(this, arguments);
}
function _withTokenRefresh() {
  _withTokenRefresh = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(getTokenFn, operationFn) {
    var retries,
      isUnauthorized,
      _args6 = arguments,
      _t5,
...
function ChatKitComponent(_ref3) {
  ...
  var handleFileUpload = (0,react.useCallback)(/*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(file, chatkitMethods) {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 6:
            ...
            _context3.n = 7;
            return fetch("/api/openai/import-s3", {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
          ...
          case 7:
            importResp = _context3.v;
            if (importResp.ok) {
              _context3.n = 9;
              break;
            }
            _context3.n = 8;
            return importResp.text();
          case 8:
            _errorText = _context3.v;
            throw new Error("Failed to import from S3: ".concat(importResp.status, " ").concat(_errorText));
          case 9:
            _context3.n = 10;
            return importResp.json();
          case 10:
  ...
  (0,react.useEffect)(function () {
    ...
    var checkElement = function checkElement() {
      ...
      if (el) {
        ...
        console.log('[ChatKit] Element attributes:', Array.from(el.attributes).map(function (attr) {
        ...
        if (shadowRoot) {
          ...
          var composer = shadowRoot.querySelector('[data-testid*="composer"], [class*="composer"], textarea, input[type="text"]');
          ...
          if (composer) {
            console.log('[ChatKit] Composer element:', {
              ...
              attributes: Array.from(composer.attributes).map(function (attr) {
                return "".concat(attr.name, "=\"").concat(attr.value, "\"");
              })
            });
          }
          ...
          var attachmentButton = shadowRoot.querySelector('[data-testid*="attach"], [data-testid*="attachment"], [aria-label*="attach"], [class*="attach"], [class*="paperclip"], button[title*="attach"]');
          ...
          var attachmentElements = shadowRoot.querySelectorAll('[class*="attach"], [data-testid*="attach"], [aria-label*="file"], [title*="file"]');
          console.log('[ChatKit] Elements with attachment-related attributes:', attachmentElements.length);
          attachmentElements.forEach(function (elem, idx) {
            console.log("[ChatKit] Attachment element ".concat(idx, ":"), {
